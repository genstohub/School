...
export default function InstructorDashboard() {
    ...
    const actions = [
        ...
        { title: "Assignment", icon: ClipboardList, color: "text-teal-400", href: "/instructor/assignment" },
        { title: "Tests", icon: FileCheck, color: "text-purple-400", href: "/instructor/test" },
        { title: "Quiz", icon: HelpCircle, color: "text-pink-400", href: "/instructor/quiz" },
        { title: "CBT", icon: GraduationCap, color: "text-orange-400", href: "/instructor/cbt" },
        { title: "Rate Students", icon: Star, color: "text-yellow-300", href: "/instructor/rate" }
    ];
        ...
        <div className="min-h-screen w-full bg-[#0F172A] text-white overflow-x-hidden">
            <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto mt-10">
                ...
                <header className="w-full bg-[#1E293B] border border-[#334155] rounded-2xl p-6 shadow-xl flex justify-between items-center">
                    ...
                    <Link href="/instructor/profile" className="bg-[#334155] px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#475569] transition shadow-lg">
                        CheckIns
                    </Link>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link href="/instructor/status" className="bg-[#1E293B] border border-[#334155] rounded-2xl p-5 hover:border-yellow-500/50 transition group relative overflow-hidden">
                    ...
                    <Link href="/instructor/community" className="bg-[#1E293B] border border-[#334155] rounded-2xl p-5 hover:border-purple-500/50 transition">
                    ...
                    <Link href="/instructor/support" className="bg-[#1E293B] border border-[#334155] rounded-2xl p-5 hover:border-blue-500/50 transition">
