...
import { 
  ...
  Settings2, Clock, CheckSquare, AlertCircle,
  LayoutGrid, HelpCircle, FileText, Send
} from "lucide-react";
...
export default function TestCreationPage({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-6 md:p-12">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 mb-16 border-l-4 border-amber-500 pl-6">
          ...
          <div className="flex gap-4">
            <div className="bg-gray-900/50 border border-gray-800 p-4 rounded-2xl flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-black text-gray-500 uppercase">Duration (Mins)</p>
                <input 
                  type="number" 
                  value={duration}
        ...
        {/* Title Input */}
        <div className="mb-12">
          <label className="text-[10px] font-black uppercase text-gray-500 ml-1 tracking-widest mb-3 block">Examination Title</label>
          <input 
            value={testTitle}
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8 ml-4">
                  <div className="flex-1">
                    <label className="text-[10px] font-black uppercase text-gray-600 tracking-[0.2em] mb-4 block">Question Text</label>
                    <textarea 
                      value={q.text}
                    ...
                    >
                      <button 
                        ...
                        className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                          q.correctAnswer === optIdx ? "bg-amber-500 border-amber-500" : "border-gray-700"
                        }`}
                      >
                        {q.correctAnswer === optIdx && <div className="w-2 h-2 bg-black rounded-full" />}
                      </button>
                      <input 
                        value={opt}
        ...
        <div className="mt-20 pt-10 border-t border-gray-900 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6 text-gray-500">
             <div className="flex items-center gap-2">
                <FileText size={16} />
                <span className="text-[10px] font-black uppercase">{questions.length} Questions</span>
             </div>
             <div className="flex items-center gap-2">
                <CheckSquare size={16} />
                <span className="text-[10px] font-black uppercase">MCQ Format</span>
             </div>
          </div>
      ...
      {isSubmitting && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-950/90 backdrop-blur-xl p-6">
          ...
          >
            ...
            <h2 className="text-3xl font-black tracking-tighter uppercase mb-2">Test Live!</h2>
